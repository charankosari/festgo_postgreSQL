...
router.route("/password/update").put(isAuthorized,merchantController.updatePassword);
router.route("/me/profileupdate").put(isAuthorized, merchantController.profileUpdate);
// property routes 
router.post('/properties',isAuthorized,roleAuthorize('merchant'), propertyController.createProperty);
router.get('/properties',isAuthorized,roleAuthorize('merchant'), propertyController.getAllProperties);
